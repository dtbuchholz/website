    ...
    <aside className="-ml-[8px] mb-12 tracking-tight">
      <div className="lg:sticky lg:top-20">
        <nav
          ...
          id="nav"
        >
          <div className="flex flex-row space-x-0 pr-10 justify-between w-full">
            <div className="flex flex-row space-x-0">
              <Link
                href="/"
                className="transition-all hover:text-neutral-800 dark:hover:text-neutral-200 flex items-center align-middle relative py-1 px-2 m-1 font-bold text-lg leading-none"
              >
                dan buchholz
              </Link>
