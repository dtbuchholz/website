  ...
  return (
    <section>
      ...
      <p className="mb-8">
        ...
        involved in another early stage startup, prior to more recently moving to New York City.
        Below are some of the things I've worked on and a general timeline.
      </p>
        ...
        events={[
          {
            ...
            content: (
              <>
                ...
                <NextLink href="https://linktr.ee/textileio">Textile</NextLink>. We build web3
                native storage solutions. This started with{" "}
                <NextLink href="https://docs.tableland.xyz">Tableland</NextLink>, which is a
                decentralized SQLite database that gives you a way to write SQL onchain (smart
                ...
                <NextLink href="https://basin.textile.io/">Basin</NextLink>. Think of it as a hot
                data layer for decentralized applications with mix across S3 and Cloudflare
                functionality. Fast finality, large scale data (GiBs per transaction)—all
                programmable onchain within horizontally scalable subnets and custom consensus. A
                lot of Rust, some Solidity, and SDKs in JS/TS.
              </>
            ),
          },
          {
            ...
            content: (
              <>
                ...
                , written in Rust. Around the same time, I was building small apps that interacted
                with onchain mechanisms or external APIs, like reading price data off of CEXs or
          ...
          },
          {
            ...
            content: (
              <>
                ...
                hired me in operations, but I quickly moved into sales engineering. We built a
                platform for IoT device tracking, providing machine learning predictions through
                integrations with various hardware vendors and global shipment data aggregation. I
                joined right after the Series A when we were a small team of ~20. By the time I
                left, we were around 500 people, Series D, and some acquisitions of adjacent tech
                that was integrated into our platform.
              </>
            ),
          },
          {
